...
public class SolutionSelectSystem : EventSystemScript
{
    ...
    void Awake()
    {
        var storyTags = GameManagerScript.instance.assetManager.get3NewStoryTags(true);
        //var storyTags = GameManagerScript.instance.assetManager.get3NewStoryTagSolutions(); // removed
