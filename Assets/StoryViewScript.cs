...
public class StoryViewScript : MonoBehaviour {
    ...
    protected readonly Vector3 defaultSpawnPos = new Vector3(370, -60);
    ...
    protected Transform contentField;
    protected List<StoryTagScript> storyTagElements;
    protected List<TraitScript> traitElements;
    protected List<StoryLink> storyLinks;
    protected List<LinkScript> linkLines;

    protected List<Action<TraitScript>> traitClickListeners;
    protected List<Action<StoryTagScript>> storyTagClickListeners;
    ...
    protected void autofitContentField()
    {
